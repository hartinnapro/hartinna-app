  ...
  <div>
    ...
    <div v-if="state === 'loading'" class="sk-screen">
      ...
      <div class="sk-main">
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e8d8d4;overflow:hidden;">
          <div v-for="i in 4" :key="i" style="display:flex;align-items:center;gap:14px;padding:14px 16px;border-bottom:1px solid #e8d8d4;">
          ...
          <div class="info-card" style="padding:16px;">
            ...
            <div class="form-group">
              ...
              <div class="input-wrap">
                <input v-model="pw.new" :type="showPw ? 'text' : 'password'" placeholder="Min. 6 characters" />
            ...
            <div class="form-group" style="margin-bottom:14px;">
              ...
              <input v-model="pw.confirm" :type="showPw ? 'text' : 'password'" placeholder="Repeat password" />
            </div>
